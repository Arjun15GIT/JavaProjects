package com.pixeltrice.spring_boot_image_gallary_app.controller;

import com.pixeltrice.spring_boot_image_gallary_app.entity.ImageGallary;
import com.pixeltrice.spring_boot_image_gallary_app.service.ImageGalleryService;
...
public class ImageGalleryController {
    ...
    public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name,
        ...
        try {
            ...
            // Storing in database in form of bytes
            byte[] imageData = file.getBytes();
            ImageGallary imageGallery = new ImageGallary();
    ...
    @ResponseBody
    void showImage(@PathVariable("id") Long id, HttpServletResponse response, Optional<ImageGallary> imageGallery)
    ...
    String showProductDetails(@RequestParam("id") Long id, Optional<ImageGallary> imageGallery, Model model) {
        try {
            log.info("Id :: " + id);
            if (id != 0) {
                imageGallery = imageGalleryService.getImageById(id);
    ...
    String show(Model map) {
        List<ImageGallary> images = imageGalleryService.getAllActiveImages();
